//dependencies
    ...
    //SWITCH ANONYMOUS FORM
    let checkBox = document.querySelector("input[id=anon]")
        
	if (document.getElementById("registerEntity").checked == false & document.getElementById("registerEntity").checked == null){
